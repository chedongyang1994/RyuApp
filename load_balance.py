...
class load_balance(app_manager.RyuApp):
	...
	def __init__(self,*args,**kwargs):
		super(load_balance,self).__init__(*args,**kwargs)
		self.mac_to_port={}
		self.datapaths={}
		self.FLAGS=True
	...
	def _build_packet_out(self,datapath,buffer_id,src_port,dst_port,data):
		...
		out=datapath.ofproto_parser.OFPPacketOut(
			datapath=datapath,buffer_id=buffer_id,data=msg_data,
	...
	def flood(self,msg):
		...
		out=self._build_packet_out(datapath,ofproto.OFP_NO_BUFFER,
					ofproto.OFPP_CONTROLLER,ofproto.OFPP_FLOOD,msg.data)
		datapath.send_msg(out)
	...
	def send_group_mod(self,datapath):
		...
		group_id=50
		req=ofp_parser.OFPGroupMod(datapath,ofproto.OFPFC_ADD,ofproto.OFPGT_SELECT,
						group_id,buckets)
